...
## 🛠 Skills Demonstrated
* **API Integration:** Deep experience connecting REST APIs using OAuth2 and API Keys.
* **Data Transformation:** Complex data manipulation using **JavaScript (Code Nodes)** and expressions.
* **Error Handling:** Implementation of "Error Trigger" nodes to ensure system stability.
* **Secure Credential Management:** Strictly separating logic from sensitive secrets using n8n's encrypted credential store.

---

## 🧰 Tech Stack
- **Automation:** n8n (Level 2 Badge)
- **Data:** Airtable, Google Sheets, Power BI
